...
export const DEFAULT_LAYOUTS = {
  lg: [
    // Row 0-2: Alerts (details shown by default, needs more height)
    { i: 'weather-alerts', x: 0, y: 0, w: 12, h: 3 },
    // Row 3-5: Current conditions + Wind + UV
    { i: 'current-conditions', x: 0, y: 3, w: 6, h: 3 },
    { i: 'wind', x: 6, y: 3, w: 3, h: 3 },
    { i: 'uv-index', x: 9, y: 3, w: 3, h: 3 },
    // Row 6-12: Weather Map prominent full width
    { i: 'weather-map', x: 0, y: 6, w: 12, h: 7 },
    // Row 13-16: Forecasts side by side
    { i: 'hourly-forecast', x: 0, y: 13, w: 6, h: 4 },
    { i: 'temperature-forecast', x: 6, y: 13, w: 6, h: 4 },
    // Row 17-19: Air quality + Sun + Moon (3 equal columns)
    { i: 'air-quality', x: 0, y: 17, w: 4, h: 3 },
    { i: 'sun', x: 4, y: 17, w: 4, h: 3 },
    { i: 'moon', x: 8, y: 17, w: 4, h: 3 },
  ],
  md: [
    { i: 'weather-alerts', x: 0, y: 0, w: 8, h: 3 },
    { i: 'current-conditions', x: 0, y: 3, w: 5, h: 3 },
    { i: 'wind', x: 5, y: 3, w: 3, h: 3 },
    { i: 'weather-map', x: 0, y: 6, w: 8, h: 7 },
    { i: 'hourly-forecast', x: 0, y: 13, w: 8, h: 4 },
    { i: 'temperature-forecast', x: 0, y: 17, w: 8, h: 4 },
    { i: 'air-quality', x: 0, y: 21, w: 4, h: 3 },
    { i: 'uv-index', x: 4, y: 21, w: 4, h: 3 },
    { i: 'sun', x: 0, y: 24, w: 4, h: 3 },
    { i: 'moon', x: 4, y: 24, w: 4, h: 3 },
  ],
  sm: [
    { i: 'weather-alerts', x: 0, y: 0, w: 4, h: 3 },
    { i: 'current-conditions', x: 0, y: 3, w: 4, h: 3 },
    { i: 'weather-map', x: 0, y: 6, w: 4, h: 6 },
    { i: 'hourly-forecast', x: 0, y: 12, w: 4, h: 4 },
    { i: 'temperature-forecast', x: 0, y: 16, w: 4, h: 4 },
    { i: 'wind', x: 0, y: 20, w: 2, h: 4 },
    { i: 'uv-index', x: 2, y: 20, w: 2, h: 3 },
    { i: 'air-quality', x: 0, y: 24, w: 4, h: 3 },
    { i: 'sun', x: 0, y: 27, w: 2, h: 3 },
    { i: 'moon', x: 2, y: 27, w: 2, h: 3 },
  ],
  xs: [
    { i: 'weather-alerts', x: 0, y: 0, w: 2, h: 3 },
    { i: 'current-conditions', x: 0, y: 3, w: 2, h: 3 },
    { i: 'weather-map', x: 0, y: 6, w: 2, h: 6 },
    { i: 'hourly-forecast', x: 0, y: 12, w: 2, h: 4 },
    { i: 'temperature-forecast', x: 0, y: 16, w: 2, h: 4 },
    { i: 'wind', x: 0, y: 20, w: 2, h: 4 },
    { i: 'uv-index', x: 0, y: 24, w: 2, h: 3 },
    { i: 'air-quality', x: 0, y: 27, w: 2, h: 3 },
    { i: 'sun', x: 0, y: 30, w: 2, h: 3 },
    { i: 'moon', x: 0, y: 33, w: 2, h: 3 },
  ],
};
